          ...
          <div className="bg-primary/50 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-xl border border-white/10">
            <form ref={formRef} onSubmit={handleSubmit}>
              <div className="mb-5">
                <label
                  htmlFor="nombre"
                  className="block mb-2 font-mono text-white"
                >
              ...
              <div className="mb-5">
                ...
                >
                  ...
                  <option value="Grabación" style={{ color: "black" }}>
                    Grabación
                  </option>
                  <option value="Producción" style={{ color: "black" }}>
                    Producción
                  </option>
                  <option value="Mezcla" style={{ color: "black" }}>
                    Mezcla
                  </option>
                  <option value="Mastering" style={{ color: "black" }}>
                    Mastering
                  </option>
                  <option value="Ensayo" style={{ color: "black" }}>
                    Ensayo
                  </option>
                  <option value="Otro" style={{ color: "black" }}>
                    Otro
                  </option>
                </select>
              ...
              {formData.necesidad === "Otro" && (
                <div className="mb-5">
                  <label
                    htmlFor="necesidadOtra"
                    className="block mb-2 font-mono text-white"
                  >
                    Especifica tu necesidad{" "}
                    <span className="text-yellow">*</span>
                  </label>
                  <input
                    type="text"
